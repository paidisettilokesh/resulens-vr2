                    ...
                    >
                                    ...
                                    <div className="p-10 bg-rose-500/5 rounded-[3rem] border border-rose-500/10 animate-fade-in">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {rewrittenResume.skillGapAnalysis.map((gap, i) => (
                                                <span key={i} className="px-5 py-2.5 bg-white rounded-xl text-xs font-bold text-rose-600 border border-rose-100 shadow-sm uppercase tracking-tight">/ {gap}</span>
                                            ))}
                                        </div>
                                    </div>
                                )}
                                ...
                                {rewrittenResume?.rewrittenBullets?.map((section, idx) => (
                                    <div key={idx} className="grid md:grid-cols-2 gap-8 relative p-2">
                                        <div className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-100 relative group overflow-hidden">
                                            ...
                                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-6 block">Legacy Bullet Point</span>
                                            <p className="text-sm text-slate-500 font-medium leading-relaxed italic line-through decoration-rose-200 decoration-2">{section.original}</p>
                                        </div>
                                        <div className="bg-white p-8 rounded-[2.5rem] border-2 border-primary-100 shadow-xl relative group">
                                            ...
                                            <p className="text-base text-slate-800 font-bold leading-relaxed">{section.rewritten}</p>
                                            <div className="mt-8 pt-6 border-t border-slate-50 flex items-start gap-3">
                                                ...
                                                <p className="text-xs font-black text-emerald-600 uppercase tracking-wide">Rationale: <span className="text-slate-600 normal-case font-bold">{section.reasoning}</span></p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                        ...
                        {activeSubTab === 'tailor' && (
                            <div className="space-y-8">
                                <div className="grid md:grid-cols-2 gap-8">
                                    ...
                                    <div className="bg-slate-50 p-10 rounded-[3rem] text-slate-800 flex flex-col justify-center relative overflow-hidden shadow-xl border border-slate-100">
                                        ...
                                        {!tailorData ? (
                                            <div className="text-center space-y-4">
                                                ...
                                                <h4 className="text-xl font-bold text-slate-800">Strategic Compatibility</h4>
                                                <p className="text-slate-500 text-sm font-medium">Deconstructing your profile against specific employer requirements.</p>
                                            </div>
                                        ) : (
                                            <div className="space-y-10">
                                                <div className="flex items-center justify-between border-b border-slate-200 pb-6">
                                                    <div>
                                                        ...
                                                        <p className="text-4xl font-bold tracking-tight text-slate-800">{tailorData.matchScore}%</p>
                                                    </div>
                                                ...
                                                <div className="space-y-6">
                                                    <div>
                                                        ...
                                                        <div className="grid grid-cols-2 gap-3">
                                                            {tailorData.keywordAnalysis?.map((kw, i) => (
                                                                <div key={i} className="p-4 bg-white rounded-2xl border border-slate-100 flex items-center justify-between group hover:border-emerald-200 transition-colors">
                                                                    <div className="flex flex-col">
                                                                        <span className="text-[10px] font-black text-slate-700">{kw.keyword}</span>
                                                                        <span className="text-[8px] font-bold text-slate-400 uppercase tracking-tighter">Imp: {kw.jdImportance}</span>
                                                                    </div>
                                                    ...
                                                    <div>
                                                        <h5 className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-4">Critical Skill Gaps</h5>
                                                        <div className="flex flex-wrap gap-2">
                                ...
                                {tailorData && (
                                    <div className="bg-white p-12 rounded-[4rem] border-2 border-emerald-100 shadow-xl animate-fade-in divide-y divide-slate-100">
                                        <div className="pb-8">
                                            <h4 className="text-lg font-black text-slate-800 mb-4 flex items-center gap-3"><Lightbulb className="text-amber-500" /> Recruiter Gap Analysis</h4>
                                            <p className="text-sm text-slate-600 font-bold leading-relaxed italic pr-12">"{tailorData.recruiterGapAnalysis}"</p>
                                        </div>
                                        <div className="pt-8 space-y-4">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                {tailorData.suggestedEdits?.map((adj, i) => (
                                                    <div key={i} className="p-6 bg-slate-50 rounded-[2rem] border border-slate-100 flex flex-col gap-3">
                                                        <div className="flex items-center gap-3">
                                                            <div className="w-6 h-6 bg-white rounded-lg border border-slate-200 flex items-center justify-center text-[10px] font-black text-slate-400">{i + 1}</div>
                                                            <span className="text-[10px] font-black text-cyan-600 uppercase tracking-widest">{adj.context}</span>
                                                        </div>
                                                        <p className="text-sm font-bold text-slate-800 leading-relaxed">{adj.suggestion}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                        ...
                        {activeSubTab === 'cover-letter' && (
                            <div className="space-y-8 animate-fade-in px-4">
                                <div className="bg-white p-12 rounded-[3.5rem] border border-slate-100 shadow-sm text-center">
                                    ...
                                    <h3 className="text-3xl font-black text-slate-800 mb-3">Premium Executive Intent</h3>
                                    <p className="text-slate-500 mb-10 max-w-xl mx-auto font-medium">Drafting a high-fidelity, dual-mode cover letter engineered for immediate recruiter resonance.</p>
                                ...
                                {coverLetter?.coverLetter && (
                                    <div className="md:col-span-2 p-12 bg-cyan-50 rounded-[4rem] text-slate-800 shadow-xl border border-cyan-100 relative overflow-hidden group">
                                        ...
                                        <div className="flex flex-col md:flex-row justify-between md:items-center gap-6 mb-10 pb-6 border-b border-cyan-200 uppercase tracking-[0.2em] font-bold text-xs">
                                            <div className="flex items-center gap-3 text-cyan-600">
                                                <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center border border-cyan-100 shadow-sm"><UserCheck size={20} /></div>
                                        ...
                                        <pre className="whitespace-pre-wrap font-serif text-slate-700 text-xl leading-relaxed italic max-w-4xl relative z-10">{coverLetter.coverLetter}</pre>
                                        <div className="mt-12 flex justify-between items-center bg-white p-6 rounded-3xl border border-cyan-100 shadow-sm">
                                            <p className="text-[10px] font-bold text-slate-500 tracking-widest uppercase">Tone Setting: <span className="text-cyan-600">{coverLetter.toneAnalysis}</span></p>
                        ...
                        {activeSubTab === 'linkedin' && (
                            <div className="space-y-10 animate-fade-in px-4 pb-20">
                                <div className="bg-[#0077b5] p-16 rounded-[4rem] text-white overflow-hidden relative shadow-2xl">
                                    <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 rounded-full translate-x-32 -translate-y-32 blur-3xl opacity-30" />
                                    <div className="relative z-10 flex flex-col md:flex-row items-center gap-12 text-center md:text-left">
                                        <div className="p-6 bg-white rounded-[2rem] text-[#0077b5] shadow-2xl shadow-black/20"><Linkedin size={60} /></div>
                                        <div>
                                        ...
                                        <button onClick={() => runFeature('linkedin')} disabled={loading} className="md:ml-auto px-12 py-6 bg-white text-[#0077b5] rounded-3xl font-black hover:bg-opacity-90 transition-all shadow-2xl text-lg flex items-center gap-3 active:scale-95">
                                ...
                                {linkedinData && (
                                    <div className="grid lg:grid-cols-3 gap-8">
                                        <div className="lg:col-span-2 space-y-8">
                                            <div className="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm relative group overflow-hidden">
                                                ...
                                                <div className="flex items-center gap-4 mb-8">
                                                    ...
                                                    <div className="h-0.5 bg-slate-50 flex-grow" />
                                                </div>
                                                <h4 className="text-2xl font-black text-slate-800 leading-tight mb-8">{linkedinData.headline}</h4>
                                            ...
                                            <div className="bg-white p-10 rounded-[3.5rem] border border-slate-100 shadow-sm">
                                                <div className="flex justify-between items-center mb-10 pb-6 border-b border-slate-50">
                                                    ...
                                                    <button onClick={() => handleCopy(linkedinData.about, 'li_a')} className="flex items-center gap-2 text-[10px] font-black text-slate-400 hover:text-cyan-600 uppercase tracking-widest transition-colors">
                                                        {copyStatus === 'li_a' ? <CheckCircle size={14} className="text-emerald-500" /> : <Copy size={14} />}
                                                        {copyStatus === 'li_a' ? 'Copied' : 'Copy Full Story'}
                                                    </button>
                                                </div>
                                                <div className="text-base text-slate-700 font-bold leading-relaxed whitespace-pre-line p-10 bg-slate-50/50 rounded-[3rem] border border-slate-100 italic">
                                                    {linkedinData.about}
                                                </div>
                                            </div>
                                            ...
                                            {linkedinData.experience && (
                                                <div className="space-y-4">
                                                    <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest block ml-6">Optimized LinkedIn Experience Bullets</span>
                                                    {linkedinData.experience.map((exp, i) => (
                                                        <div key={i} className="p-8 bg-white rounded-[2.5rem] border border-slate-100 shadow-sm group">
                                                            <h5 className="text-[10px] font-black text-primary-600 uppercase mb-4">{exp.company}</h5>
                                                            <p className="text-sm font-bold text-slate-700 leading-relaxed italic">"{exp.rewritten}"</p>
                                                        </div>
                                                    ))}
                                                </div>
                                            )}
                                        ...
                                        <div className="space-y-8">
                                            <div className="bg-cyan-50 p-8 rounded-[3rem] text-slate-800 shadow-xl border border-cyan-100 relative overflow-hidden group">
                                                ...
                                                <p className="text-sm font-bold leading-relaxed italic text-slate-600">
                        ...
                        {activeSubTab === 'email' && (
                            <div className="space-y-12 animate-fade-in px-4 pb-20">
                                <div className="bg-slate-50 p-16 rounded-[4rem] text-slate-800 text-center shadow-xl border border-slate-100 relative overflow-hidden">
                                    <div className="absolute top-0 right-0 w-64 h-64 bg-cyan-500/5 rounded-full translate-x-20 -translate-y-20 blur-3xl" />
                                    <div className="inline-block p-6 bg-white rounded-3xl mb-8 border border-slate-100 shadow-sm"><Mail size={60} className="text-cyan-600" /></div>
                                    <h3 className="text-5xl font-bold mb-4 tracking-tighter text-slate-800">Outreach Engine <span className="text-cyan-600">v2</span></h3>
                                    <p className="text-slate-500 font-medium text-xl mb-12 max-w-2xl mx-auto italic">"Cold outreach is a numbers game. We provide the winning numbers."</p>
                                ...
                                {emailData?.templates && (
                                    <div className="grid md:grid-cols-2 gap-8">
                                        {emailData.templates.map((tmpl, idx) => (
                                            <div key={idx} className="bg-white p-10 rounded-[3.5rem] border border-slate-100 shadow-sm flex flex-col h-full hover:shadow-xl transition-all relative group">
                                                ...
                                                <div className="mb-6 pb-6 border-b border-slate-50">
                                                    ...
                                                    <h4 className="font-black text-lg text-slate-800 leading-tight">{tmpl.subject}</h4>
                                                </div>
                                                <pre className="text-sm text-slate-600 whitespace-pre-wrap font-sans leading-loose flex-grow bg-slate-50/50 p-8 rounded-[2.5rem] mb-8 border border-slate-100 italic transition-colors group-hover:bg-white">
                                                    {tmpl.body}
                                                </pre>
